...
CREATE TABLE IF NOT EXISTS `om_users` (
  ...
  `userLogin` varchar(30) NOT NULL default '',
  `userLang` enum('en','ar','zh','de','nl','fr','es','it','el','ja','pt','ru','th','ro','ko','fi','bn','et','hu','ht','id','he','uk') NOT NULL default 'en',
...
(1, 'manager', 'en', 'X8LKbwhZGfL3dibx4oD6ucyStO3J7cU6xu7j9yxcUI6GnunWepbWOYbRTBwrgsNf9fMUlL6oMQFUJPWclv_2ZA', NULL, 'yourmail@yourdomain.com', '', '', 'Registry Manager', '', '', '', '', '', '', '', 'admin', 'active', '0000-00-00', '2009-03-06 08:24:18', 0, '0', 'waiting', 0, '0000-00-00', 'active', 3, '0000-00-00'),
(2, 'sysaccount', 'en', 'X8LKbwhZGfL3dibx4oD6ucyStO3J7cU6xu7j9yxcUI6GnunWepbWOYbRTBwrgsNf9fMUlL6oMQFUJPWclv_2ZA', NULL, 'yourmail@yourdomain.com', '', '', 'System Account', '', '', '', '', '', '', '', 'sysaccount', 'active', '0000-00-00', '2008-12-23 09:50:18', 0, '0', 'waiting', 0, '0000-00-00', 'active', 0, '0000-00-00'),
(3, 'cash', 'en', 'X8LKbwhZGfL3dibx4oD6ucyStO3J7cU6xu7j9yxcUI6GnunWepbWOYbRTBwrgsNf9fMUlL6oMQFUJPWclv_2ZA', NULL, '', '', NULL, 'Cash Account', '', '', '', '', '', '', '', 'sysaccount', 'active', '0000-00-00', '2008-12-23 06:16:34', 0, '', 'active', 0, '0000-00-00', 'active', 0, '0000-00-00'),
(4, 'liquidity', 'en', 'X8LKbwhZGfL3dibx4oD6ucyStO3J7cU6xu7j9yxcUI6GnunWepbWOYbRTBwrgsNf9fMUlL6oMQFUJPWclv_2ZA', NULL, '', '', NULL, 'Liquidity Adjustment', '', '', '', '', '', '', '', 'sysaccount', 'active', '0000-00-00', '2008-12-23 13:01:03', 0, '', 'active', 0, '0000-00-00', 'active', 0, '0000-00-00');
